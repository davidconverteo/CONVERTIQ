...
const HabitsTab = ({ data }: { data: any }) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card><CardHeader className="flex-row items-center gap-2"><Image src="https://i.postimg.cc/BvSXnkMw/Convert-IQ-logo.png" alt="ConvertIQ Logo" width={32} height={32} className="object-contain" /><CardTitle>Synthèse & Recommandations IA</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">Vos produits sont principalement consommés en **fin de repas** (dessert) et au **petit-déjeuner**. Le bénéfice principal recherché est la **gourmandise**, suivi de près par la **santé**.</p><p className="text-sm text-muted-foreground mt-2">Il existe une tension intéressante entre le plaisir et la nutrition.</p><p className="text-sm text-muted-foreground mt-2"><strong>Recommandation :</strong> Mettez en avant le double bénéfice "sain et gourmand" dans votre communication. Développez des recettes ou des suggestions de présentation pour l'usage au petit-déjeuner afin de renforcer ce moment de consommation.</p></CardContent></Card>
        </div>
    );
};
                ...
                <div className="mt-6">
                 ...
                 <TabsContent value="indicators" className="mt-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <Card>
                            <CardHeader className="flex-row items-center gap-2"><Image src="https://i.postimg.cc/BvSXnkMw/Convert-IQ-logo.png" alt="ConvertIQ Logo" width={32} height={32} className="object-contain" /><CardTitle>Analyse des Indicateurs</CardTitle></CardHeader>
