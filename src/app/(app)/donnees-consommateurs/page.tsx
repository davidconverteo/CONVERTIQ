                ...
                <div className="mt-6">
                 ...
                 <TabsContent value="indicators" className="mt-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <Card>
                            <CardHeader className="flex-row items-center gap-2"><Image src="https://i.postimg.cc/sX4YyC2j/Convert-IQ-logo-2.png" alt="ConvertIQ Logo" width={24} height={24} className="object-contain" /><CardTitle>Analyse des Indicateurs</CardTitle></CardHeader>
